...
class MedicalCondition(Base):
    ...
    diagnosed_date: Mapped[datetime | None] = mapped_column(
        DateTime,
        nullable=True,
    )
    ...
    patient = relationship(
        "Patient",
        back_populates="medical_condition_records",
    )
...
class Allergy(Base):
    ...
    patient = relationship(
        "Patient",
        back_populates="allergy_records",
    )
